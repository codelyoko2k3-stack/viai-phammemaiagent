  ...
  return (
    <div className="space-y-6">
      ...
      <AdminPageHeader
        ...
        description={`${products.length} sản phẩm hiển thị tại /ai-agent. Đổi "Thứ tự" để sắp xếp lại trên trang public. Có Badge mới được lên trang chủ.`}
        showBack={false}
      >
        <Link
