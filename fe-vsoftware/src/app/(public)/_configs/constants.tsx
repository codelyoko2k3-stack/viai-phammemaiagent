import type { AiCard, PainCard, Plan, ServiceCard, WhyItem, WhyStat } from './types';
...
export const PLANS: Plan[] = [
  {
    ...
    cta: { label: 'Nhận tư vấn', href: 'https://zalo.me/viai', variant: 'ghost' },
    featured: false,
  },
  {
    name: 'Growth',
    ...
    cta: { label: 'Đặt lịch khảo sát', href: 'https://zalo.me/viai', variant: 'solid' },
    featured: true,
  },
  {
    name: 'Enterprise',
