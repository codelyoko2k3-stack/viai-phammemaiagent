...
function CtaSection({ config }: { config?: HomepageCtaConfig }) {
  ...
  const description = config?.description ?? 'Tư vấn miễn phí 30 phút — ViAI phân tích bài toán và đề xuất giải pháp phù hợp. Không ràng buộc.'
  ...
  const ctaSecondaryHref = config?.ctaSecondaryHref ?? 'https://zalo.me/viai'
