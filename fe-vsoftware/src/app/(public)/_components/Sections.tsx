...
export function HeroSection({ config }: { config?: HomepageHeroConfig }) {
  ...
  const description = config?.description ?? 'Không dùng chung giải pháp đại trà. ViAI xây cho bạn đúng bài toán — CRM, App Mobile, Automation, Workflow — đúng chi phí, đúng tiến độ.'
  ...
  const heroImageAlt = config?.heroImageAlt ?? 'ViAI hero'
