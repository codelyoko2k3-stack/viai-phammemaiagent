      ...
      <div className="p-6 md:p-10">
        ...
        <div className="text-[15.5px] text-[#374151] leading-[1.8]">
          ...
          <div className="bg-gradient-to-br from-[#1E5BC6] via-[#2E6FD6] to-[#F47920] rounded-[12px] p-7 md:px-8 text-center mt-8">
            ...
            <p className="text-[14px] text-white/80 mb-5">ViAI thiết lập AI Agent Kế toán tích hợp sâu vào quy trình tài chính của doanh nghiệp bạn</p>
            <div className="flex flex-wrap gap-3 justify-center">
              <a
                href="https://zalo.me/viai"
                target="_blank"
                rel="noreferrer"
